...
class Event(object):
    ...
    def __str__(self):
        ...
        if self._outdoors == "Y" or self._outdoors == "Yes" or self._outdoors == "y" or self._outdoors == "yes":
            self._outdoors = True
        elif self._outdoors == "N" or self._outdoors == "No" or self._outdoors == "n" or self._outdoors == "no":
            self._outdoors = False
        if self._cover_available == "Y" or self._cover_available == "Yes" or self._cover_available == "y" or self._cover_available == "yes":
            self._cover_available = True
        elif self._cover_available == "N" or self._cover_available == "No" or self._cover_available == "n" or self._cover_available == "no":
...
class EventDecision(object):
    ...
    def _temperature_factor(self):
        ...
        if (temperature_factor < 0) and (((6 <= event_time <= 19) and (event_outdoors == True) and (adjusted_high_temperature >= 30)) or (adjusted_high_temperature >= 45)):
            if event_cover == True:
...
class UserInteraction(object):
    ...
    def __init__(self):
        """
        Parameters:
            event (Event): An event that will be instantiated later.
            prediction_model (WeatherPrediction): An Specific prediction model that will be instantiated later.
                             An object of a subclass of WeatherPrediction used 
                             to predict the weather for the event.
        """
        self._event = None
    ...
    def get_prediction_model(self, weather_data):
        ...
        if model_choice == '1' :
            ...
            n = int(input("Enter how many days of data you wish to use for making the prediction: "))
    ...
    def another_check(self):
        ...
        if another_check == "Y" or another_check == "Yes" or another_check == "y" or another_check == "yes":
            return True
        elif another_check == "N" or another_check == "No" or another_check == "n" or another_check == "no":
            return False
